...
console.log("");
console.log("%cYou can creep on more of my work from my personal site (arnaud.cr), my portfolio site (miniml.co), or my github (@areknow). I also mess around with my camera (@areknowsee) when im not busy filling brackets.", "color: grey; font-size: medium");
console.log("");
